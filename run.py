...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/MALS/approval.txt/blob/main/Ap.txt"])
...
def notice():
	...
	subprocess.check_output(["am", "start", "https://www.facebook.com/adi.ashik1122"])
